    ...
    def afficher(self):
        ...
        while i < 10:
            ...
            while j < len(self.table[i]) : 
                print("{} {} {} {} {} {} {} {} {} {}\n".format(self.table[i][j][0],self.table[i][j][1],self.table[i][j][2],self.table[i][j][3],self.table[i][j][4],self.table[i][j][5],self.table[i][j][6],self.table[i][j][7],self.table[i][j][8],self.table[i][j][9]))
                j+=1
            i+=1
    ...
    def search(self,age):
        ...
        while i < len(self.table[index]):
            if age == self.table[index][i][3]:
                print("{} {} {} {} {} {} {} {} {} {}\n".format(self.table[index][i][0],self.table[index][i][1],self.table[index][i][2],self.table[index][i][3],self.table[index][i][4],self.table[index][i][5],self.table[index][i][6],self.table[index][i][7],self.table[index][i][8],self.table[index][i][9]))
            i+=1
